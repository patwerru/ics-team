...
Route::get('upload', 'UploadsController@upload')->name('uploads');



//Supper Magistrate middleware
Route::group(['middleware' => 'magistrate'], function (){
    Route::get('magistrate', 'MagistratesController@welcome')->name('magistrate.dashboard');
    Route::get('view-users', 'MagistratesController@user_list')->name('magistrate.view-users');
});
Route::group(['middleware' => 'admin'], function (){

});
Route::group(['middleware' => 'registry'], function (){
    Route::get('registrar', 'RegistryController@registryStaff')->name('registry.dashboard');
});
...
// Dashboard
Route::get('dashboard', 'PagesController@welcome')->name('centaur.dashboard');
