                ...
                <div class="panel-body">
                    <form accept-charset="UTF-8" role="form" method="post" action="{{ route('auth.login.attempt') }}">
                        <fieldset>
                            ...
                            <p style="margin-top:5px; margin-bottom:0"><a href="{{ route('auth.password.request.form') }}" type="submit">Forgot your password?</a>  &nbsp; &nbsp; <a href="{{ route('auth.register.form') }}" type="submit">Register</a></p>
                        </fieldset>
                    </form>
                </div>
            </div>
